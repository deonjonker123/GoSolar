...
public class BatteryBlockMenu extends AbstractContainerMenu {
    ...
    public BatteryBlockMenu(int containerId, Inventory inv, BlockEntity blockEntity, ContainerData containerData) {
        super(GSMenuTypes.BATTERY_MENU.get(), containerId);
        ...
        this.addSlot(new Slot(this.blockEntity.getInventory(), 1, 152, 56));

        this.addSlot(new Slot(this.blockEntity.getInventory(), 0, 116, 56));
    }
